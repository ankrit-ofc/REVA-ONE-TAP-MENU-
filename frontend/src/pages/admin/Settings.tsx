...
/** Payment QR: upload with preview, replace, remove. Mirrors the Menu Design
 *  page's banner upload — uploads apply immediately and the backend validates
 *  content, size, and dimensions (the QR is stored uncropped and lossless so
 *  it stays scannable). */
